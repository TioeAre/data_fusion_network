...
def main():
    ...
    parser.add_argument('-g', '--gpu', type=int,
                        required=True, help='gpu id', default="0")
    parser.add_argument('--resume', help='checkpoint path', default=False)
    ...
    parser.add_argument(
        '--pretrained-model',
        default="/home/tioeare/project/FASTLAB/network/data_fusion_fcn/model/fcn16s-heavy-pascal.pth",
